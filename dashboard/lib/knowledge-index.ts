...
// Fuente: 16 ficheros. 260 secciones (190 con SQL,
...
export const KNOWLEDGE_INDEX: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    "body": "```sql\nSELECT gl.\"codigo\" AS \"Código\", gl.\"descripcion\" AS \"Descripción\", COALESCE(SUM(gl.\"unidades\") FILTER (WHERE gf.\"abono\" IS NOT TRUE), 0) - COALESCE(SUM(gl.\"unidades\") FILTER (WHERE gf.\"abono\" IS TRUE), 0) AS \"Unidades\", COALESCE(SUM(gl.\"total\") FILTER (WHERE gf.\"abono\" IS NOT TRUE), 0) - COALESCE(SUM(gl.\"total\") FILTER (WHERE gf.\"abono\" IS TRUE), 0) AS \"Importe\" FROM \"public\".\"ps_gc_lin_facturas\" gl JOIN \"public\".\"ps_gc_facturas\" gf ON gf.\"reg_factura\" = gl.\"num_factura\" WHERE NOT EXISTS (SELECT 1 FROM \"public\".\"ps_clientes\" ci WHERE ci.\"reg_cliente\" = gf.\"num_cliente\" AND COALESCE(ci.\"nif\", '') = '502108150') AND gl.\"fecha_factura\" BETWEEN :curr_from AND :curr_to GROUP BY gl.\"codigo\", gl.\"descripcion\" ORDER BY \"Importe\" DESC LIMIT 20\n```",
    "hasSql": true,
    "dialect": "postgres"
  },
  {
  ...
  {
    "source": "docs/dashboard/sql-pairs.md",
    "heading": "¿Cuáles son los 10 artículos (referencia + color) más vendidos por cantidad?",
  ...
  {
    "source": "docs/dashboard/sql-pairs.md",
    "heading": "¿Cuáles son los 10 artículos más vendidos? (por modelo, que es el nivel correcto)",
