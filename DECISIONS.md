...
| [D-035](docs/decisions/D-035-action-required-bot-gating.md) | GitHub marca como `action_required` los runs de `pull_request_review` disparados por un bot; la vía de recuperación es el watchdog `*/30` por `workflow_dispatch`. |
